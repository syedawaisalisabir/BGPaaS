    ...
    if(!this.options.compact) {
      ...
      if(this.schema.type === 'array'){
          ...
          addItemIcon.addEventListener('click',function(e) {
              ...
              var blockEle = $(this.parentElement.parentElement).find('.well-small')[0].firstChild.getAttribute('style');
              var parentEle = this.parentElement.parentElement.getAttribute('data-schemapath').split('.');
              if( blockEle == 'display:block' || blockEle == 'display: block;' || blockEle == 'display:block;' || blockEle == 'border-left: 1px dotted rgb(229, 229, 229); margin-left: 9px; display: block;'){
                  if(parentEle.length == 3){
                      $(this.parentElement.parentElement).find('.well-small')[0].firstChild.lastChild.setAttribute('style','display:none;');
                  }else{
                      if($(this.parentElement.parentElement).find('.well-small')[0].firstChild.lastChild.getAttribute('data-schematype') == 'array'){
                         $(this.parentElement.parentElement).find('.well-small')[0].firstChild.lastChild.setAttribute('style','display:none;margin-left:9px;border-left:1px dotted #e5e5e5;');
                      }else{
                         $(this.parentElement.parentElement).find('.well-small')[0].firstChild.lastChild.setAttribute('style','display:none;');
                      }
                  }
              ...
              $($(this.parentElement.parentElement).find('.well-small')[0]).slideDown(1200);
              self.collapsed = false;
